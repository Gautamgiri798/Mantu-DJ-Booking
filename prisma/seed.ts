...
async function main() {
  ...
  const services = [
    ...
    {
      title: 'Concert Grade Sound System',
      slug: 'concert-sound-system',
      category: 'Sound',
      description:
        'Heavy dual 18-inch subwoofers with punchy bass you can feel in your chest, paired with crystal clear high-frequency Line Array mid-tops.',
      priceStarting: 20000,
      features: JSON.stringify([
        'Original JBL / RCF / Yamaha professional acoustic lineup',
        'Dual 18" high-excursion subwoofers for deep earthshaking bass',
        'Digital DBX crossover management & clean amplifiers',
        'Power backup compatible & voltage-regulated setup',
      ]),
      iconName: 'Speaker',
      imageUrl: 'https://images.unsplash.com/photo-1545128485-c400e7702796?auto=format&fit=crop&w=1000&q=80',
      order: 4,
    },
    {
      title: 'Intelligent Beam Lighting & Lasers',
      slug: 'intelligent-lighting',
      category: 'Lighting',
      description:
        'Sharpy 7R/10R high-intensity moving heads, programmable multi-color laser arrays, warm white ambient stage washers, and strobe effects.',
      priceStarting: 12000,
      features: JSON.stringify([
        'Synchronized DMX lighting controller matching song drops',
        'Sharpy moving head beams cutting through haze',
        'RGBWA UV wash par cans for stage & banquet hall illumination',
        'Safety-certified rigging & aluminum goalpost trusses',
      ]),
      iconName: 'Zap',
